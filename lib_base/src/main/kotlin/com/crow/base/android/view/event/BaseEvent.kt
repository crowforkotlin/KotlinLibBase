...
val baseEvent: BaseEvent by lazy { BaseEvent.newInstance(BaseEvent.BASE_FLAG_TIME_500) }
 ...
 */
class BaseEvent private constructor(mFlagTime: Long) {
     ...
     * ● 事件仅一次初始化
     *
     * ● 2023-12-12 17:17:28 周二 下午
     * @author crowforkotlin
     */
    fun eventInitLimitOnce(onInit: () -> Unit): Unit? {
        if (!mInitOnce) {
            mInitOnce = true
            onInit()
            return Unit
